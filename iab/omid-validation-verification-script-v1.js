...
function fireEvent(event) {
  var params = serialize(event),
      url = "http://complianceomsdk.iabtechlab.com/sendmessage?" + params;
  fireURL(url);
}
...
(function(omidGlobal) {
  ...
  fireURL("http://complianceomsdk.iabtechlab.com/sendmessage?version=" + key);

  if (!verificationClient.isSupported()) {
    fireURL("http://complianceomsdk.iabtechlab.com/sendmessage?supported=no");
  ...
  fireURL("http://complianceomsdk.iabtechlab.com/sendmessage?supported=yes");
