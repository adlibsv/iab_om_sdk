...
function fireEvent(event) {
    var params = serialize(event),
        url = "https://raw.githubusercontent.com/adlibsv/iab_om_sdk/main/testing/omid-signal.png?" + params;
    fireURL(url);
}
...
(function(omidGlobal) {
    ...
    fireURL("https://raw.githubusercontent.com/adlibsv/iab_om_sdk/main/testing/omid-signal.png?version=" + key);

    if (!verificationClient.isSupported()) {
        fireURL("https://raw.githubusercontent.com/adlibsv/iab_om_sdk/main/testing/omid-signal.png?supported=no");
    ...
    fireURL("https://raw.githubusercontent.com/adlibsv/iab_om_sdk/main/testing/omid-signal.png?supported=yes");
